...
insert into asignaturas(nombre, area)
values
...
INSERT INTO productos_secuenciales(proveedor_id, nombre, cantidad, precio) VALUES
(1,'NEVERA',6,500.25),
(1,'COCINA',3,300.75),
(2,'LAVADORA',2,800.50),
...
SELECT PROVEEDORES_SECUENCIAL.NOMBRE AS PROVEEDOR,
       PRODUCTOS_SECUENCIALES.NOMBRE AS PRODUCTO,
       PRODUCTOS_SECUENCIALES.CANTIDAD,
       PRODUCTOS_SECUENCIALES.PRECIO
FROM PROVEEDORES_SECUENCIAL
RIGHT JOIN PRODUCTOS_SECUENCIALES ON PROVEEDORES_SECUENCIAL.ID = PRODUCTOS_SECUENCIALES.PROVEEDOR_ID;
...
SELECT PROVEEDORES_SECUENCIAL.NOMBRE AS PROVEEDOR,
       ...
       PRODUCTOS_SECUENCIALES.PRECIO
FROM PROVEEDORES_SECUENCIAL
LEFT JOIN PRODUCTOS_SECUENCIALES ON PROVEEDORES_SECUENCIAL.ID = PRODUCTOS_SECUENCIALES.PROVEEDOR_ID
UNION 
SELECT PROVEEDORES_SECUENCIAL.NOMBRE AS PROVEEDOR,
       PRODUCTOS_SECUENCIALES.NOMBRE AS PRODUCTO,
       PRODUCTOS_SECUENCIALES.CANTIDAD,
